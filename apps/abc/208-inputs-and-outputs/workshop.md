...
- Move the sample data from VideoListComponent to DashboardComponent and
  pass it down into the VideoListComponent.
...
- Verify that clicking a video still results in visually identifying the
  selected video.

- Edit your video list component to emit an event when a video is
  selected.

- Update the video player component in the middle to display that
